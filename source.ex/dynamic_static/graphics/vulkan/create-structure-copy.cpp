...
void create_pnext_copy(void* pNext, const VkAllocationCallbacks* pAllocationCallbacks);
...
VkAllocationCallbacks create_structure_copy<VkAllocationCallbacks>(const VkAllocationCallbacks& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pUserData = create_dynamic_array_copy(1, obj.pUserData, pAllocationCallbacks);
...
VkAndroidSurfaceCreateInfoKHR create_structure_copy<VkAndroidSurfaceCreateInfoKHR>(const VkAndroidSurfaceCreateInfoKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.flags = create_structure_copy(obj.flags, pAllocationCallbacks);
    result.window = create_dynamic_array_copy(1, obj.window, pAllocationCallbacks);
    return result;
}
#endif // VK_USE_PLATFORM_ANDROID_KHR
...
VkCheckpointDataNV create_structure_copy<VkCheckpointDataNV>(const VkCheckpointDataNV& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pCheckpointMarker = create_dynamic_array_copy(1, obj.pCheckpointMarker, pAllocationCallbacks);
    return result;
}
...
VkDebugMarkerMarkerInfoEXT create_structure_copy<VkDebugMarkerMarkerInfoEXT>(const VkDebugMarkerMarkerInfoEXT& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.color, obj.color);
    return result;
}
...
VkDeviceCreateInfo create_structure_copy<VkDeviceCreateInfo>(const VkDeviceCreateInfo& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.ppEnabledLayerNames = create_dynamic_string_array_copy(obj.enabledLayerCount, obj.ppEnabledLayerNames, pAlloactionCallbacks);
    result.enabledExtensionCount = create_structure_copy(obj.enabledExtensionCount, pAllocationCallbacks);
    result.ppEnabledExtensionNames = create_dynamic_string_array_copy(obj.enabledExtensionCount, obj.ppEnabledExtensionNames, pAlloactionCallbacks);
...
VkDeviceGroupPresentCapabilitiesKHR create_structure_copy<VkDeviceGroupPresentCapabilitiesKHR>(const VkDeviceGroupPresentCapabilitiesKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.sType = create_structure_copy(obj.sType, pAllocationCallbacks);
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    create_static_array_copy(result.presentMask, obj.presentMask);
...
VkExportFenceWin32HandleInfoKHR create_structure_copy<VkExportFenceWin32HandleInfoKHR>(const VkExportFenceWin32HandleInfoKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.sType = create_structure_copy(obj.sType, pAllocationCallbacks);
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.pAttributes = create_dynamic_array_copy(1, obj.pAttributes, pAllocationCallbacks);
...
VkExtensionProperties create_structure_copy<VkExtensionProperties>(const VkExtensionProperties& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_string_copy(result.extensionName, obj.extensionName);
...
VkIOSSurfaceCreateInfoMVK create_structure_copy<VkIOSSurfaceCreateInfoMVK>(const VkIOSSurfaceCreateInfoMVK& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.flags = create_structure_copy(obj.flags, pAllocationCallbacks);
    result.pView = create_dynamic_array_copy(1, obj.pView, pAllocationCallbacks);
    return result;
}
...
VkImageBlit create_structure_copy<VkImageBlit>(const VkImageBlit& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.srcOffsets, obj.srcOffsets);
    result.dstSubresource = create_structure_copy(obj.dstSubresource, pAllocationCallbacks);
    create_static_array_copy(result.dstOffsets, obj.dstOffsets);
    return result;
}
...
VkImportAndroidHardwareBufferInfoANDROID create_structure_copy<VkImportAndroidHardwareBufferInfoANDROID>(const VkImportAndroidHardwareBufferInfoANDROID& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.sType = create_structure_copy(obj.sType, pAllocationCallbacks);
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.buffer = create_dynamic_array_copy(1, obj.buffer, pAllocationCallbacks);
    return result;
}
#endif // VK_USE_PLATFORM_ANDROID_KHR
...
VkImportMemoryHostPointerInfoEXT create_structure_copy<VkImportMemoryHostPointerInfoEXT>(const VkImportMemoryHostPointerInfoEXT& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.handleType = create_structure_copy(obj.handleType, pAllocationCallbacks);
    result.pHostPointer = create_dynamic_array_copy(1, obj.pHostPointer, pAllocationCallbacks);
    return result;
}
...
VkLayerProperties create_structure_copy<VkLayerProperties>(const VkLayerProperties& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_string_copy(result.layerName, obj.layerName);
    result.specVersion = create_structure_copy(obj.specVersion, pAllocationCallbacks);
    result.implementationVersion = create_structure_copy(obj.implementationVersion, pAllocationCallbacks);
    create_static_string_copy(result.description, obj.description);
    return result;
}
...
VkMetalSurfaceCreateInfoEXT create_structure_copy<VkMetalSurfaceCreateInfoEXT>(const VkMetalSurfaceCreateInfoEXT& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.flags = create_structure_copy(obj.flags, pAllocationCallbacks);
    result.pLayer = create_dynamic_array_copy(1, obj.pLayer, pAllocationCallbacks);
    return result;
}
...
VkNativeBufferANDROID create_structure_copy<VkNativeBufferANDROID>(const VkNativeBufferANDROID& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.sType = create_structure_copy(obj.sType, pAllocationCallbacks);
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.handle = create_dynamic_array_copy(1, obj.handle, pAllocationCallbacks);
    result.stride = create_structure_copy(obj.stride, pAllocationCallbacks);
    result.format = create_structure_copy(obj.format, pAllocationCallbacks);
    result.usage = create_structure_copy(obj.usage, pAllocationCallbacks);
...
VkPerformanceCounterDescriptionKHR create_structure_copy<VkPerformanceCounterDescriptionKHR>(const VkPerformanceCounterDescriptionKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.flags = create_structure_copy(obj.flags, pAllocationCallbacks);
    create_static_string_copy(result.name, obj.name);
    create_static_string_copy(result.category, obj.category);
    create_static_string_copy(result.description, obj.description);
    return result;
}
...
VkPerformanceCounterKHR create_structure_copy<VkPerformanceCounterKHR>(const VkPerformanceCounterKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.uuid, obj.uuid);
    return result;
}
...
VkPhysicalDeviceDriverProperties create_structure_copy<VkPhysicalDeviceDriverProperties>(const VkPhysicalDeviceDriverProperties& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_string_copy(result.driverName, obj.driverName);
    create_static_string_copy(result.driverInfo, obj.driverInfo);
...
VkPhysicalDeviceGroupProperties create_structure_copy<VkPhysicalDeviceGroupProperties>(const VkPhysicalDeviceGroupProperties& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.physicalDeviceCount = create_structure_copy(obj.physicalDeviceCount, pAllocationCallbacks);
    create_static_array_copy(result.physicalDevices, obj.physicalDevices);
...
VkPhysicalDeviceIDProperties create_structure_copy<VkPhysicalDeviceIDProperties>(const VkPhysicalDeviceIDProperties& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.sType = create_structure_copy(obj.sType, pAllocationCallbacks);
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    create_static_array_copy(result.deviceUUID, obj.deviceUUID);
    create_static_array_copy(result.driverUUID, obj.driverUUID);
    create_static_array_copy(result.deviceLUID, obj.deviceLUID);
...
VkPhysicalDeviceLimits create_structure_copy<VkPhysicalDeviceLimits>(const VkPhysicalDeviceLimits& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.maxComputeWorkGroupCount, obj.maxComputeWorkGroupCount);
    result.maxComputeWorkGroupInvocations = create_structure_copy(obj.maxComputeWorkGroupInvocations, pAllocationCallbacks);
    create_static_array_copy(result.maxComputeWorkGroupSize, obj.maxComputeWorkGroupSize);
    ...
    create_static_array_copy(result.maxViewportDimensions, obj.maxViewportDimensions);
    create_static_array_copy(result.viewportBoundsRange, obj.viewportBoundsRange);
    ...
    create_static_array_copy(result.pointSizeRange, obj.pointSizeRange);
    create_static_array_copy(result.lineWidthRange, obj.lineWidthRange);
...
VkPhysicalDeviceMemoryBudgetPropertiesEXT create_structure_copy<VkPhysicalDeviceMemoryBudgetPropertiesEXT>(const VkPhysicalDeviceMemoryBudgetPropertiesEXT& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.sType = create_structure_copy(obj.sType, pAllocationCallbacks);
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    create_static_array_copy(result.heapBudget, obj.heapBudget);
    create_static_array_copy(result.heapUsage, obj.heapUsage);
    return result;
}
...
VkPhysicalDeviceMemoryProperties create_structure_copy<VkPhysicalDeviceMemoryProperties>(const VkPhysicalDeviceMemoryProperties& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.memoryTypes, obj.memoryTypes);
    result.memoryHeapCount = create_structure_copy(obj.memoryHeapCount, pAllocationCallbacks);
    create_static_array_copy(result.memoryHeaps, obj.memoryHeaps);
    return result;
}
...
VkPhysicalDeviceMeshShaderPropertiesNV create_structure_copy<VkPhysicalDeviceMeshShaderPropertiesNV>(const VkPhysicalDeviceMeshShaderPropertiesNV& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.maxTaskWorkGroupSize, obj.maxTaskWorkGroupSize);
    ...
    create_static_array_copy(result.maxMeshWorkGroupSize, obj.maxMeshWorkGroupSize);
...
VkPhysicalDeviceProperties create_structure_copy<VkPhysicalDeviceProperties>(const VkPhysicalDeviceProperties& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_string_copy(result.deviceName, obj.deviceName);
    create_static_array_copy(result.pipelineCacheUUID, obj.pipelineCacheUUID);
...
VkPhysicalDeviceSampleLocationsPropertiesEXT create_structure_copy<VkPhysicalDeviceSampleLocationsPropertiesEXT>(const VkPhysicalDeviceSampleLocationsPropertiesEXT& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.maxSampleLocationGridSize = create_structure_copy(obj.maxSampleLocationGridSize, pAllocationCallbacks);
    create_static_array_copy(result.sampleLocationCoordinateRange, obj.sampleLocationCoordinateRange);
...
VkPhysicalDeviceToolPropertiesEXT create_structure_copy<VkPhysicalDeviceToolPropertiesEXT>(const VkPhysicalDeviceToolPropertiesEXT& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    create_static_string_copy(result.name, obj.name);
    create_static_string_copy(result.version, obj.version);
    result.purposes = create_structure_copy(obj.purposes, pAllocationCallbacks);
    create_static_string_copy(result.description, obj.description);
    create_static_string_copy(result.layer, obj.layer);
    return result;
}
...
VkPipelineColorBlendStateCreateInfo create_structure_copy<VkPipelineColorBlendStateCreateInfo>(const VkPipelineColorBlendStateCreateInfo& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.attachmentCount = create_structure_copy(obj.attachmentCount, pAllocationCallbacks);
    result.pAttachments = create_dynamic_array_copy(obj.attachmentCount, obj.pAttachments, pAllocationCallbacks);
    create_static_array_copy(result.blendConstants, obj.blendConstants);
    return result;
}
...
VkRayTracingShaderGroupCreateInfoKHR create_structure_copy<VkRayTracingShaderGroupCreateInfoKHR>(const VkRayTracingShaderGroupCreateInfoKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pShaderGroupCaptureReplayHandle = create_dynamic_array_copy(1, obj.pShaderGroupCaptureReplayHandle, pAllocationCallbacks);
    return result;
}
#endif // VK_ENABLE_BETA_EXTENSIONS
...
VkShaderStatisticsInfoAMD create_structure_copy<VkShaderStatisticsInfoAMD>(const VkShaderStatisticsInfoAMD& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.computeWorkGroupSize, obj.computeWorkGroupSize);
    return result;
}
...
VkTransformMatrixKHR create_structure_copy<VkTransformMatrixKHR>(const VkTransformMatrixKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy(result.matrix, obj.matrix);
    return result;
}
#endif // VK_ENABLE_BETA_EXTENSIONS
#endif // DYNAMIC_STATIC_VK_STRUCTURE_REQUIRES_CUSTOM_HANDLING
...
VkWaylandSurfaceCreateInfoKHR create_structure_copy<VkWaylandSurfaceCreateInfoKHR>(const VkWaylandSurfaceCreateInfoKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.flags = create_structure_copy(obj.flags, pAllocationCallbacks);
    result.display = create_dynamic_array_copy(1, obj.display, pAllocationCallbacks);
    result.surface = create_dynamic_array_copy(1, obj.surface, pAllocationCallbacks);
    return result;
}
...
VkXcbSurfaceCreateInfoKHR create_structure_copy<VkXcbSurfaceCreateInfoKHR>(const VkXcbSurfaceCreateInfoKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.flags = create_structure_copy(obj.flags, pAllocationCallbacks);
    result.connection = create_dynamic_array_copy(1, obj.connection, pAllocationCallbacks);
...
VkXlibSurfaceCreateInfoKHR create_structure_copy<VkXlibSurfaceCreateInfoKHR>(const VkXlibSurfaceCreateInfoKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    result.pNext = create_pnext_copy(obj.pNext, pAllocationCallbacks);
    result.flags = create_structure_copy(obj.flags, pAllocationCallbacks);
    result.dpy = create_dynamic_array_copy(1, obj.dpy, pAllocationCallbacks);
    result.window = create_structure_copy(obj.window, pAllocationCallbacks);
    return result;
}
...
void create_pnext_copy(void* pNext, const VkAllocationCallbacks* pAllocationCallbacks)
{
    if (pNext) {
        ...
        case VK_STRUCTURE_TYPE_APPLICATION_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkApplicationInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkInstanceCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_QUEUE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceQueueCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SUBMIT_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSubmitInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryAllocateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMappedMemoryRange*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BIND_SPARSE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindSparseInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FENCE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFenceCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSemaphoreCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EVENT_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkEventCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_QUERY_POOL_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkQueryPoolCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_VIEW_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferViewCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageViewCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkShaderModuleCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineCacheCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineShaderStageCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineVertexInputStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineInputAssemblyStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineTessellationStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineViewportStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineRasterizationStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineMultisampleStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineDepthStencilStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineColorBlendStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineDynamicStateCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGraphicsPipelineCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COMPUTE_PIPELINE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkComputePipelineCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineLayoutCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSamplerCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorSetLayoutCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorPoolCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorSetAllocateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWriteDescriptorSet*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COPY_DESCRIPTOR_SET: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCopyDescriptorSet*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FRAMEBUFFER_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFramebufferCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCommandPoolCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCommandBufferAllocateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCommandBufferInheritanceInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCommandBufferBeginInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassBeginInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferMemoryBarrier*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageMemoryBarrier*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_BARRIER: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryBarrier*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_LOADER_INSTANCE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkLoaderInstanceCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_LOADER_DEVICE_CREATE_INFO: {
            return create_vk_structure_dynamic_array_copy(1, *(VkLoaderDeviceCreateInfo*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COHERENT_MEMORY_FEATURES_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceCoherentMemoryFeaturesAMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_NATIVE_HDR_SURFACE_CAPABILITIES_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayNativeHdrSurfaceCapabilitiesAMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SWAPCHAIN_DISPLAY_NATIVE_HDR_CREATE_INFO_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSwapchainDisplayNativeHdrCreateInfoAMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_MEMORY_OVERALLOCATION_CREATE_INFO_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceMemoryOverallocationCreateInfoAMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_COMPILER_CONTROL_CREATE_INFO_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineCompilerControlCreateInfoAMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineRasterizationStateRasterizationOrderAMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderCorePropertiesAMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_2_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderCoreProperties2AMD*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD: {
            return create_vk_structure_dynamic_array_copy(1, *(VkTextureLodGatherFormatPropertiesAMD*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_USAGE_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkANDROIDHardwareBufferUsageANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_PROPERTIES_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkANDROIDHardwareBufferPropertiesANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkANDROIDHardwareBufferFormatPropertiesANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_IMPORT_ANDROID_HARDWARE_BUFFER_INFO_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportANDROIDHardwareBufferInfoANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_MEMORY_GET_ANDROID_HARDWARE_BUFFER_INFO_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryGetANDROIDHardwareBufferInfoANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalFormatANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_NATIVE_BUFFER_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkNativeBufferANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_SWAPCHAIN_IMAGE_CREATE_INFO_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSwapchainImageCreateInfoANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_ANDROID: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePresentationPropertiesANDROID*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_IMAGE_VIEW_ASTC_DECODE_MODE_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageViewAstcDecodeModeEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ASTC_DECODE_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceAstcDecodeFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_ADVANCED_STATE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineColorBlendAdvancedStateCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceBufferDeviceAddressFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_ADDRESS_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceBufferAddressFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferDeviceAddressInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferDeviceAddressCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCalibratedTimestampInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_CONDITIONAL_RENDERING_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCommandBufferInheritanceConditionalRenderingInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONDITIONAL_RENDERING_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceConditionalRenderingFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_CONDITIONAL_RENDERING_BEGIN_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkConditionalRenderingBeginInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONSERVATIVE_RASTERIZATION_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceConservativeRasterizationPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_CONSERVATIVE_STATE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineRasterizationConservativeStateCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_NAME_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugMarkerObjectNameInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_TAG_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugMarkerObjectTagInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_MARKER_MARKER_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugMarkerMarkerInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugReportCallbackCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_REPORT_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugReportCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugUtilsObjectNameInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_TAG_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugUtilsObjectTagInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugUtilsLabelEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CALLBACK_DATA_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugUtilsMessengerCallbackDataEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDebugUtilsMessengerCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_ENABLE_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDepthClipEnableFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_DEPTH_CLIP_STATE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineRasterizationDepthClipStateCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorSetLayoutBindingFlagsCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDescriptorIndexingFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDescriptorIndexingPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorSetVariableDescriptorCountAllocateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorSetVariableDescriptorCountLayoutSupportEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDiscardRectanglePropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_DISCARD_RECTANGLE_STATE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineDiscardRectangleStateCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_POWER_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayPowerInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_EVENT_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceEventInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_EVENT_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayEventInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SWAPCHAIN_COUNTER_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSwapchainCounterCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceCapabilities2EXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES2_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceCapabilities2EXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportMemoryHostPointerInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_HOST_POINTER_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryHostPointerPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceExternalMemoryHostPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_VIEW_IMAGE_FORMAT_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceImageViewImageFormatInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FILTER_CUBIC_IMAGE_VIEW_IMAGE_FORMAT_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFilterCubicImageViewImageFormatPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceFragmentDensityMapFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceFragmentDensityMapPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassFragmentDensityMapCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_INTERLOCK_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceFullScreenExclusiveInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_FULL_SCREEN_EXCLUSIVE_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceCapabilitiesFullScreenExclusiveEXT*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_WIN32_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceFullScreenExclusiveWin32InfoEXT*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceQueueGlobalPriorityCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_HDR_METADATA_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkHdrMetadataEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_HEADLESS_SURFACE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkHeadlessSurfaceCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceHostQueryResetFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDrmFormatModifierPropertiesListEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDrmFormatModifierPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_DRM_FORMAT_MODIFIER_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceImageDrmFormatModifierInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_LIST_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageDrmFormatModifierListCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_EXPLICIT_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageDrmFormatModifierExplicitCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageDrmFormatModifierPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceIndexTypeUint8FeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceInlineUniformBlockFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceInlineUniformBlockPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWriteDescriptorSetInlineUniformBlockEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorPoolInlineUniformBlockCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceLineRasterizationFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineRasterizationLineStateCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceLineRasterizationPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_BUDGET_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMemoryBudgetPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PRIORITY_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMemoryPriorityFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_PRIORITY_ALLOCATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryPriorityAllocateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_METAL_EXT
        case VK_STRUCTURE_TYPE_METAL_SURFACE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMetalSurfaceCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_METAL_EXT
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PCI_BUS_INFO_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePciBusInfoPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineCreationFeedbackCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SAMPLE_LOCATIONS_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSampleLocationsInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassSampleLocationsBeginInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_SAMPLE_LOCATIONS_STATE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineSampleLocationsStateCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLE_LOCATIONS_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSampleLocationsPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MULTISAMPLE_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMultisamplePropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSamplerReductionModeCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceScalarBlockLayoutFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageStencilUsageCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSubgroupSizeControlPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineShaderStageRequiredSubgroupSizeCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSubgroupSizeControlFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceTexelBufferAlignmentPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceTextureCompressionAstcHdrFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceToolPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceTransformFeedbackFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceTransformFeedbackPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_STREAM_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineRasterizationStateStreamCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_VALIDATION_CACHE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkValidationCacheCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SHADER_MODULE_VALIDATION_CACHE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkShaderModuleValidationCacheCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_VALIDATION_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkValidationFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkValidationFlagsEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineVertexInputDivisorStateCreateInfoEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_IMAGE_ARRAYS_FEATURES_EXT: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceYcbcrImageArraysFeaturesEXT*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_FUCHSIA
        case VK_STRUCTURE_TYPE_IMAGEPIPE_SURFACE_CREATE_INFO_FUCHSIA: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImagepipeSurfaceCreateInfoFUCHSIA*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_FUCHSIA
        #ifdef VK_USE_PLATFORM_GGP
        case VK_STRUCTURE_TYPE_PRESENT_FRAME_TOKEN_GGP: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPresentFrameTokenGGP*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_GGP
        #ifdef VK_USE_PLATFORM_GGP
        case VK_STRUCTURE_TYPE_STREAM_DESCRIPTOR_SURFACE_CREATE_INFO_GGP: {
            return create_vk_structure_dynamic_array_copy(1, *(VkStreamDescriptorSurfaceCreateInfoGGP*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_GGP
        case VK_STRUCTURE_TYPE_PRESENT_TIMES_INFO_GOOGLE: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPresentTimesInfoGOOGLE*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_QUERY_POOL_CREATE_INFO_INTEL: {
            return create_vk_structure_dynamic_array_copy(1, *(VkQueryPoolCreateInfoINTEL*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_INITIALIZE_PERFORMANCE_API_INFO_INTEL: {
            return create_vk_structure_dynamic_array_copy(1, *(VkInitializePerformanceApiInfoINTEL*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_MARKER_INFO_INTEL: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPerformanceMarkerInfoINTEL*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_STREAM_MARKER_INFO_INTEL: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPerformanceStreamMarkerInfoINTEL*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_OVERRIDE_INFO_INTEL: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPerformanceOverrideInfoINTEL*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_CONFIGURATION_ACQUIRE_INFO_INTEL: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPerformanceConfigurationAcquireInfoINTEL*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_FUNCTIONS_2_FEATURES_INTEL: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevice16bitStorageFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevice8bitStorageFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_ANDROID_SURFACE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkANDROIDSurfaceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_ANDROID_KHR
        case VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindBufferMemoryInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindImageMemoryInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceBufferDeviceAddressFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferDeviceAddressInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferOpaqueCaptureAddressCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryOpaqueCaptureAddressAllocateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceMemoryOpaqueCaptureAddressInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAttachmentDescription2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAttachmentReference2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSubpassDescription2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSubpassDependency2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassCreateInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSubpassBeginInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SUBPASS_END_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSubpassEndInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryDedicatedRequirementsKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryDedicatedAllocateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_DEFERRED_OPERATION_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeferredOperationInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDepthStencilResolvePropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSubpassDescriptionDepthStencilResolveKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorUpdateTemplateCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryAllocateFlagsInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_RENDER_PASS_BEGIN_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupRenderPassBeginInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupCommandBufferBeginInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupSubmitInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupBindSparseInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_DEVICE_GROUP_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindBufferMemoryDeviceGroupInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_DEVICE_GROUP_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindImageMemoryDeviceGroupInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_CAPABILITIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupPresentCapabilitiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_SWAPCHAIN_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageSwapchainCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_SWAPCHAIN_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindImageMemorySwapchainInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ACQUIRE_NEXT_IMAGE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAcquireNextImageInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupPresentInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_SWAPCHAIN_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupSwapchainCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GROUP_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceGroupPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupDeviceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_MODE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayModeCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_SURFACE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplaySurfaceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayPresentInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDriverPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportFenceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FENCE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceExternalFenceInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXTERNAL_FENCE_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalFencePropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMPORT_FENCE_FD_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportFenceFdInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FENCE_GET_FD_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFenceGetFdInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_IMPORT_FENCE_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportFenceWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXPORT_FENCE_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportFenceWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_FENCE_GET_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFenceGetWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalMemoryBufferCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalMemoryImageCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportMemoryAllocateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceExternalImageFormatInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalImageFormatPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceExternalBufferInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalBufferPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceIdPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportMemoryFdInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryFdPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_GET_FD_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryGetFdInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportMemoryWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportMemoryWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryWin32HandlePropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_MEMORY_GET_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryGetWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportSemaphoreCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceExternalSemaphoreInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalSemaphorePropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportSemaphoreFdInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SEMAPHORE_GET_FD_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSemaphoreGetFdInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportSemaphoreWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportSemaphoreWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkD3d12FenceSubmitInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_SEMAPHORE_GET_WIN32_HANDLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSemaphoreGetWin32HandleInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_DISPLAY_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_PLANE_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayPlaneProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_MODE_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayModeProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_PLANE_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayPlaneInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DISPLAY_PLANE_CAPABILITIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDisplayPlaneCapabilities2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BUFFER_MEMORY_REQUIREMENTS_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBufferMemoryRequirementsInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_MEMORY_REQUIREMENTS_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageMemoryRequirementsInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_SPARSE_MEMORY_REQUIREMENTS_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageSparseMemoryRequirementsInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_MEMORY_REQUIREMENTS_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMemoryRequirements2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SPARSE_IMAGE_MEMORY_REQUIREMENTS_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSparseImageMemoryRequirements2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceFeatures2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFormatProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_FORMAT_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageFormatProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceImageFormatInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_QUEUE_FAMILY_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkQueueFamilyProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMemoryProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSparseImageFormatProperties2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSparseImageFormatInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SURFACE_INFO_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSurfaceInfo2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceCapabilities2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SURFACE_FORMAT_2_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceFormat2KHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageFormatListCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceImagelessFramebufferFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFramebufferAttachmentsCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFramebufferAttachmentImageInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassAttachmentBeginInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PRESENT_REGIONS_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPresentRegionsKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePointClippingPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassInputAttachmentAspectCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageViewUsageCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineTessellationDomainOriginStateCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMaintenance3PropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_SUPPORT_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDescriptorSetLayoutSupportKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_MULTIVIEW_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassMultiviewCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMultiviewFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMultiviewPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePerformanceQueryFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePerformanceQueryPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkQueryPoolPerformanceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPerformanceQuerySubmitInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ACQUIRE_PROFILING_LOCK_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAcquireProfilingLockInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPerformanceCounterKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_DESCRIPTION_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPerformanceCounterDescriptionKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_EXECUTABLE_PROPERTIES_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineExecutablePropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineExecutableInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_STATISTIC_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineExecutableStatisticKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_INTERNAL_REPRESENTATION_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineExecutableInternalRepresentationKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_PIPELINE_LIBRARY_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineLibraryCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDevicePushDescriptorPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindAccelerationStructureMemoryInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWriteDescriptorSetAccelerationStructureKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_GEOMETRY_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureBuildGeometryInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_GEOMETRY_TYPE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureCreateGeometryTypeInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureDeviceAddressInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_AABBS_DATA_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureGeometryAabbsDataKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_INSTANCES_DATA_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureGeometryInstancesDataKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_TRIANGLES_DATA_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureGeometryTrianglesDataKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureGeometryKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureMemoryRequirementsInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureVersionKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCopyAccelerationStructureInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_TO_MEMORY_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCopyAccelerationStructureToMemoryInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_COPY_MEMORY_TO_ACCELERATION_STRUCTURE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCopyMemoryToAccelerationStructureInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceRayTracingFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceRayTracingPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRayTracingPipelineCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRayTracingShaderGroupCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        #ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_INTERFACE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRayTracingPipelineInterfaceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSamplerYcbcrConversionCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSamplerYcbcrConversionInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindImagePlaneMemoryInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImagePlaneMemoryRequirementsInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSamplerYcbcrConversionFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSamplerYcbcrConversionImageFormatPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAttachmentReferenceStencilLayoutKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAttachmentDescriptionStencilLayoutKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderAtomicInt64FeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderClockFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderFloat16Int8FeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT16_INT8_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceFloat16Int8FeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceFloatControlsPropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSharedPresentSurfaceCapabilitiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SURFACE_PROTECTED_CAPABILITIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSurfaceProtectedCapabilitiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SWAPCHAIN_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSwapchainCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PRESENT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPresentInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_CAPABILITIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceGroupPresentCapabilitiesKHR*)pNext, pAllocationCallbacks);
        } break;
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceTimelineSemaphoreFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceTimelineSemaphorePropertiesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSemaphoreTypeCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkTimelineSemaphoreSubmitInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSemaphoreWaitInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkSemaphoreSignalInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceUniformBufferStandardLayoutFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceVariablePointerFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceVariablePointersFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceVulkanMemoryModelFeaturesKHR*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_WAYLAND_KHR
        case VK_STRUCTURE_TYPE_WAYLAND_SURFACE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWaylandSurfaceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WAYLAND_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWin32KeyedMutexAcquireReleaseInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWin32SurfaceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_XCB_KHR
        case VK_STRUCTURE_TYPE_XCB_SURFACE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkXcbSurfaceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_XCB_KHR
        #ifdef VK_USE_PLATFORM_XLIB_KHR
        case VK_STRUCTURE_TYPE_XLIB_SURFACE_CREATE_INFO_KHR: {
            return create_vk_structure_dynamic_array_copy(1, *(VkXlibSurfaceCreateInfoKHR*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_XLIB_KHR
        #ifdef VK_USE_PLATFORM_IOS_MVK
        case VK_STRUCTURE_TYPE_IOS_SURFACE_CREATE_INFO_MVK: {
            return create_vk_structure_dynamic_array_copy(1, *(VkIosSurfaceCreateInfoMVK*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_IOS_MVK
        #ifdef VK_USE_PLATFORM_MACOS_MVK
        case VK_STRUCTURE_TYPE_MACOS_SURFACE_CREATE_INFO_MVK: {
            return create_vk_structure_dynamic_array_copy(1, *(VkMacosSurfaceCreateInfoMVK*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_MACOS_MVK
        #ifdef VK_USE_PLATFORM_VI_NN
        case VK_STRUCTURE_TYPE_VI_SURFACE_CREATE_INFO_NN: {
            return create_vk_structure_dynamic_array_copy(1, *(VkViSurfaceCreateInfoNN*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_VI_NN
        case VK_STRUCTURE_TYPE_IMAGE_VIEW_HANDLE_INFO_NVX: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImageViewHandleInfoNVX*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineViewportWScalingStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceComputeShaderDerivativesFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceCooperativeMatrixFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCooperativeMatrixPropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceCooperativeMatrixPropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CORNER_SAMPLED_IMAGE_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceCornerSampledImageFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COVERAGE_REDUCTION_MODE_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceCoverageReductionModeFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_REDUCTION_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineCoverageReductionStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_FRAMEBUFFER_MIXED_SAMPLES_COMBINATION_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkFramebufferMixedSamplesCombinationNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDedicatedAllocationImageCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDedicatedAllocationBufferCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDedicatedAllocationMemoryAllocateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEDICATED_ALLOCATION_IMAGE_ALIASING_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_CHECKPOINT_DATA_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCheckpointDataNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkQueueFamilyCheckpointPropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDiagnosticsConfigFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkDeviceDiagnosticsConfigCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GRAPHICS_SHADER_GROUP_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGraphicsShaderGroupCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_SHADER_GROUPS_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGraphicsPipelineShaderGroupsCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkIndirectCommandsLayoutTokenNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkIndirectCommandsLayoutCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGeneratedCommandsInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGeneratedCommandsMemoryRequirementsInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceDeviceGeneratedCommandsFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExternalMemoryImageCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportMemoryAllocateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkImportMemoryWin32HandleInfoNV*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkExportMemoryWin32HandleInfoNV*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_TO_COLOR_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineCoverageToColorStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceFragmentShaderBarycentricFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineCoverageModulationStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMeshShaderFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceMeshShaderPropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRayTracingPipelineCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GEOMETRY_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGeometryNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GEOMETRY_TRIANGLES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGeometryTrianglesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_GEOMETRY_AABB_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkGeometryAabbNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkBindAccelerationStructureMemoryInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWriteDescriptorSetAccelerationStructureNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureMemoryRequirementsInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceRayTracingPropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRayTracingShaderGroupCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkAccelerationStructureInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_REPRESENTATIVE_FRAGMENT_TEST_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_REPRESENTATIVE_FRAGMENT_TEST_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineRepresentativeFragmentTestStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_EXCLUSIVE_SCISSOR_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineViewportExclusiveScissorStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXCLUSIVE_SCISSOR_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceExclusiveScissorFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_FOOTPRINT_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderImageFootprintFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderSmBuiltinsFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShaderSmBuiltinsPropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SHADING_RATE_IMAGE_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineViewportShadingRateImageStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_FEATURES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShadingRateImageFeaturesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_PROPERTIES_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPhysicalDeviceShadingRateImagePropertiesNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_COARSE_SAMPLE_ORDER_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineViewportCoarseSampleOrderStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SWIZZLE_STATE_CREATE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkPipelineViewportSwizzleStateCreateInfoNV*)pNext, pAllocationCallbacks);
        } break;
        #ifdef VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV: {
            return create_vk_structure_dynamic_array_copy(1, *(VkWin32KeyedMutexAcquireReleaseInfoNV*)pNext, pAllocationCallbacks);
        } break;
        #endif // VK_USE_PLATFORM_WIN32_KHR
        case VK_STRUCTURE_TYPE_RESERVED_QCOM: {
            return create_vk_structure_dynamic_array_copy(1, *(VkReservedQCOM*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDER_PASS_TRANSFORM_INFO_QCOM: {
            return create_vk_structure_dynamic_array_copy(1, *(VkCommandBufferInheritanceRenderPassTransformInfoQCOM*)pNext, pAllocationCallbacks);
        } break;
        case VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM: {
            return create_vk_structure_dynamic_array_copy(1, *(VkRenderPassTransformBeginInfoQCOM*)pNext, pAllocationCallbacks);
        } break;
        default: {
        } break;
        }
