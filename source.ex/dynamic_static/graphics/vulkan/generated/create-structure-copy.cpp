...
static void create_pnext_copy(const coid* pNext, const VkAllocationCallbacks* pAllocationCallbacks)
{
    if (pNext) {
...
VkClearColorValue create_structure_copy<VkClearColorValue>(const VkClearColorValue& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy<4>(result.float32, obj.float32, pAllocationCallbacks);
    create_static_array_copy<4>(result.int32, obj.int32, pAllocationCallbacks);
    create_static_array_copy<4>(result.uint32, obj.uint32, pAllocationCallbacks);
    return result;
}
...
VkTransformMatrixKHR create_structure_copy<VkTransformMatrixKHR>(const VkTransformMatrixKHR& obj, const VkAllocationCallbacks* pAllocationCallbacks)
{
    ...
    create_static_array_copy<34>(result.matrix, obj.matrix, pAllocationCallbacks);
    return result;
}
#endif // VK_ENABLE_BETA_EXTENSIONS
